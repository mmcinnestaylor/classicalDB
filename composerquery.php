...
<div class="main">
  <h1>Classical DB</h1>
  <h2>Composer Related Queries</h2>
	<p>
  <form action = "composerqueryscript.php" method="post">
	  <label>
	  ...
	  <br>
	  <label>
	    <input type="radio" name="RadioGroup1" value="piano" id="RadioGroup1_3">
	    Composed a piano concerto</label>
	  <br>
	  <input type="submit">
	</form>
</p>
