...
<div class="main">
  <h1>Classical DB</h1>
  <h2>Conductor Related Queries</h2>
	<p>
  <form action = "conductorqueryscript.php" method="post">
	  <label>
	    <input type="radio" name="RadioGroup1" value="alpha" id="RadioGroup1_0">
	    Listed Alphabeticaly</label>
	  <br>
	  <label>
	    <input type="radio" name="RadioGroup1" value="nationality" id="RadioGroup1_1">
	    Ordered by Nationality</label>
	  <br>
	  <label>
	    <input type="radio" name="RadioGroup1" value="british" id="RadioGroup1_3">
	    Conducted a British Orchestra</label>
	  <br>
	  <input type="submit">
	</form>
</p>
