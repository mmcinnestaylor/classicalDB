...
<div class="main">
  ...
  <p>Enter a search term, and select a catagory: </p>
	<form action = "searchscript.php" method = "post">
	<p>Search term: <input type="text" name= "search">
	Catagory:<select name= "table">
		<option value="Composer">Composers</option>
		<option value="Conductor">Conductors</option>
		<option value="ConcertHall">Concert Halls</option>
