...
<body>
  ...
  <div class="dropdown-container">
    <a href="updateconductorform.php">Conductor</a>
    <a href="updatecomposerform.php">Composer</a>
  ...
  <div class="dropdown-container">
    <a href="deleteeconductorform.php">Conductor</a>
...
<div class="main">
  <h1>Classical DB</h1>
<form action = "insertconductorscript.php" method = "post">
		<h2>Update a Conductor's Information</h2>
		
		<p>Last name*: <input type="text" name= "lastname"/></p>
  		<p>First name*: <input type="text" name= "firstname"/></p>
  		<p>Birthdate*: <input type="text" id="Datepicker1" name="date"></p>
		<p>*Required Field</p>
		<p>Update: <ul><li>num one</li>
				<li>num two</li>
			</ul><input type="text" name= "lastname"/></p>
