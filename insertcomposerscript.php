...
body {
	...
	<?php 
		...
		if($result->num_rows == 0){
			...
			$result = $mysqli->query("INSERT INTO Composer(lastname, firstname, middlename, birthdate) 														VALUES('$lastname','$firstname','$middlename','$birthdate')");
	...
	<meta http-equiv="refresh" content="5; URL='insertcomposerform.php'"/>
