...
<div class="main">
  ...
  <h2>Get Music Reccommendations!</h2>
  <p>Select a composer below, then Classical DB will recommend music and composers you may enjoy!</p>
	<form action = "mymusicscript.php" method = "post">
		<p><?php echo "$opt";?></p>
