...
<div class="main">
  <h1>Classical DB</h1>
  <h2>Song Related Queries</h2>
	<p>
  <form action = "songqueryscript.php" method="post">
	  <label>
	    <input type="radio" name="RadioGroup1" value="alpha" id="RadioGroup1_0">
	    Listed Alphabeticaly</label>
	  <br>
	  <label>
	    <input type="radio" name="RadioGroup1" value="style" id="RadioGroup1_1">
	    Ordered by Style</label>
	  <br>
	   <label>
	    <input type="radio" name="RadioGroup1" value="era" id="RadioGroup1_3">
	    Ordered by Era</label>
	  <br>
	  <label>
	    <input type="radio" name="RadioGroup1" value="composer" id="RadioGroup1_3">
	    Ordered by Composer</label>
	  <br>
	   <label>
	    <input type="radio" name="RadioGroup1" value="eracomp" id="RadioGroup1_3">
	    Romantic Era Music ordered by Composer's Nationality</label>
	  <br>
	  <input type="submit">
	</form>
</p>
